// Generated by scripts/amalgamate.sh from include/plf_skiplist/detail/*.hpp. Do not edit
...
#define PLF_SKIPLIST_VERSION (PLF_SKIPLIST_VERSION_MAJOR * 10000 + PLF_SKIPLIST_VERSION_MINOR * 100 + PLF_SKIPLIST_VERSION_PATCH)
